    ...
    public partial class initialcreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupsUserPermissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupsUserPermissions_Groups_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskStateChange", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupsUserPermissions_GroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskAssignments_TaskStateChangeId",
                table: "TaskAssignments",
